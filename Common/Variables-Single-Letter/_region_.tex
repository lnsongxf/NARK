\message{ !name(Variables-Single-Letter.tex)}\documentclass{econtex}
\usepackage{econtexSetup}
\usepackage{econtexShortcuts}

\begin{document}

\message{ !name(Variables-Single-Letter.tex) !offset(-3) }
...
\message{ !name(Variables-Single-Letter.tex) !offset(-72) }
